...
function HandleDiceREAL() {
  return _HandleDiceREAL.apply(this, arguments);
}
function _HandleDiceREAL() {
  _HandleDiceREAL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var countPawnsOnBoard;
...
function Thrown6AndPawnsOnBoard() {
  return _Thrown6AndPawnsOnBoard.apply(this, arguments);
}
function _Thrown6AndPawnsOnBoard() {
  _Thrown6AndPawnsOnBoard = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
